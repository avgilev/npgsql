...
namespace Npgsql.NodaTime.Tests
{
    public class NodaTimeTests : TestBase
    {
        ...
        static readonly TestCaseData[] TimestamptzInvalidParameters =
        {
            ...
            new TestCaseData(DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Unspecified))
                .SetName("TimestamptzInvalidParameters_DateTime_Unspecified"),
            new TestCaseData(new DateTimeOffset(DateTime.SpecifyKind(DateTime.Now, DateTimeKind.Unspecified), TimeSpan.FromHours(2)))
